package com.sizheng.gware.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializeConfig;
import com.sizheng.gware.bean.WareInfo;
import com.sizheng.gware.bean.WareOrderTask;
import com.sizheng.gware.bean.WareSku;
...
public class GwareController {
    ...
    @RequestMapping(value = "wareSkuList" ,method = RequestMethod.GET,produces= MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
